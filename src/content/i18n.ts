...
const de: Dict = {
  ...
  booking: {
    ...
    submitError: "Senden fehlgeschlagen. Bitte versuchen Sie es erneut oder schreiben Sie uns direkt an info@novastackstudio.de.",
...
const en: Dict = {
  ...
  booking: {
    ...
    submitError: "Sending failed. Please try again or email us directly at info@novastackstudio.de.",
